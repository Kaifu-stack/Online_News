...
import { FaEnvelope, FaLock, FaUser, FaNewspaper, FaEye, FaEyeSlash } from "react-icons/fa";
            ...
            <div className="max-w-md w-full">
                <div className="text-center mb-8">
                    ...
                    <p className="mt-2 text-gray-500 text-sm">
                        Join us and start exploring the top stories today
                    </p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    <form onSubmit={formik.handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-3 border-2 rounded-lg ${formik.touched.name && formik.errors.name
                                        ? "border-red-400"
                                        : "border-gray-200"
                                        }`}
                                />
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full py-3 rounded-lg text-white font-semibold ${isLoading ? "bg-gray-400 cursor-not-allowed" : "bg-linear-to-r from-blue-600 to-purple-600"
                                }`}
                        >
